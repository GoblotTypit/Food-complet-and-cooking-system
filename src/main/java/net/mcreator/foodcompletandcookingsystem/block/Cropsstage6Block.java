...
import net.mcreator.foodcompletandcookingsystem.procedures.Cropsstage6UpdateTickProcedure;
import net.mcreator.foodcompletandcookingsystem.init.FoodCompletAndCookingSystemModItems;

import java.util.List;
import java.util.Collections;

public class Cropsstage6Block extends Block {
	public Cropsstage6Block() {
	...
	public void tick(BlockState blockstate, ServerLevel world, BlockPos pos, RandomSource random) {
		...
		int y = pos.getY();
		int z = pos.getZ();
		Cropsstage6UpdateTickProcedure.execute(world, x, y, z);
		world.scheduleTick(pos, this, 600);
	}
}
