...
import net.mcreator.foodcompletandcookingsystem.procedures.Cropsstage2UpdateTickProcedure;
import net.mcreator.foodcompletandcookingsystem.init.FoodCompletAndCookingSystemModItems;

import java.util.List;
import java.util.Collections;

public class Cropsstage2Block extends Block {
	public Cropsstage2Block() {
	...
	public void tick(BlockState blockstate, ServerLevel world, BlockPos pos, RandomSource random) {
		...
		int y = pos.getY();
		int z = pos.getZ();
		Cropsstage2UpdateTickProcedure.execute(world, x, y, z);
		world.scheduleTick(pos, this, 600);
	}
}
