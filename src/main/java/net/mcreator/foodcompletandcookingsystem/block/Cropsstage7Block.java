...
import net.mcreator.foodcompletandcookingsystem.procedures.Cropsstage7UpdateTickProcedure;
import net.mcreator.foodcompletandcookingsystem.init.FoodCompletAndCookingSystemModItems;

import java.util.List;
import java.util.Collections;

public class Cropsstage7Block extends Block {
	public Cropsstage7Block() {
	...
	public void tick(BlockState blockstate, ServerLevel world, BlockPos pos, RandomSource random) {
		...
		int y = pos.getY();
		int z = pos.getZ();
		Cropsstage7UpdateTickProcedure.execute(world, x, y, z);
		world.scheduleTick(pos, this, 600);
	}
}
