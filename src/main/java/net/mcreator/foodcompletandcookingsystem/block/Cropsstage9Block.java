...
import net.mcreator.foodcompletandcookingsystem.procedures.Cropsstage9UpdateTickProcedure;
import net.mcreator.foodcompletandcookingsystem.init.FoodCompletAndCookingSystemModItems;

import java.util.List;
import java.util.Collections;

public class Cropsstage9Block extends Block {
	public Cropsstage9Block() {
	...
	public List<ItemStack> getDrops(BlockState state, LootParams.Builder builder) {
		...
		return Collections.singletonList(new ItemStack(FoodCompletAndCookingSystemModItems.CORN.get()));
	}
	...
	public void tick(BlockState blockstate, ServerLevel world, BlockPos pos, RandomSource random) {
		...
		int y = pos.getY();
		int z = pos.getZ();
		Cropsstage9UpdateTickProcedure.execute(world, x, y, z);
		world.scheduleTick(pos, this, 600);
	}
}
